...
<div class="container mt-4">
    ...
    @if($adaRugi)
        <div class="alert alert-danger fw-bold text-center">
            ⚠️ PERINGATAN: ADA TRANSAKSI RUGI PADA PERIODE INI
        </div>
    @endif
            ...
            <table class="table table-bordered align-middle">
                ...
                @forelse($detail as $i => $d)
                    <tr>
                        ...
                        <td>
                            {{ \Carbon\Carbon::parse($d->tanggal_transaksi)->translatedFormat('d F Y H:i') }}
                        </td>
                        ...
                        <td class="text-end {{ $d->total_keuntungan >= 0 ? 'text-success' : 'text-danger fw-bold' }}">
