...
<div class="d-flex">
    ...
    <div class="bg-body-secondary p-3 vh-100" style="width:230px">
        <ul class="nav nav-pills flex-column gap-2">
            ...
            <li class="nav-item"><a href="/barang" class="nav-link">📦 Data Barang</a></li>
            <li class="nav-item"><a href="/suplier" class="nav-link">🚚 Data Suplier</a></li>
            <li class="nav-item"><a href="/kategori" class="nav-link">🏷️ Data Kategori</a></li>
            <li class="nav-item"><a href="/pelanggan" class="nav-link">👥 Data Pelanggan</a></li>
            <li class="nav-item"><a href="/transaksi" class="nav-link">💰 Transaksi</a></li>
            <li class="nav-item"><a href="/laporan-penjualan" class="nav-link">📊 Laporan Penjualan</a></li>
